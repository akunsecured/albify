...
import 'package:albify/widgets/conversation_element.dart';
import 'package:albify/widgets/conversation_list.dart';
...
class _ChatsViewState extends State<ChatsView> {
          ...
          : ChangeNotifierProvider(
              ...
              builder: (context, child) =>
                  StreamProvider<List<ConversationModel>>.value(
                    value: Provider.of<ConversationProvider>(context,
                            listen: false)
                        .conversations(),
                    initialData: [],
  ...
  List<ConversationModel> conversationsFromQuerySnapshot(
      ...
      data.docs
          .map((document) => ConversationModel.fromDocumentSnapshot(document))
          .toList();
