...
class _ProfileViewState extends State<ProfileView> {
  ...
  Widget buildProfileView(UserModel userModel, Size size) =>
    Container(
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: RawMaterialButton(
                      child: Icon(Icons.camera_alt, color: AppStyle.appColorGreen,),
  ...
  selectImage() async {
    ...
    if (result != null) {
      await Provider.of<DatabaseService>(context, listen: false).uploadProfilePicture(result.files.first);
    }
  }
}
