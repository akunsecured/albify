  ...
  CustomPageRouteBuilder(
      ...
      : super(
          ...
          transitionsBuilder: (BuildContext context,
            ...
            if (parent == null)
              return SlideTransition(position: childPosition, child: child);

            var parentPosition =
                Tween<Offset>(begin: Offset.zero, end: to).animate(animation);

            return Stack(
              children: [
                SlideTransition(position: parentPosition, child: parent),
                SlideTransition(position: childPosition, child: child)
              ],
            );
          },
        );
